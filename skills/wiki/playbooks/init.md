...
3. Devolve controle ao orquestrador `/seobrain:start` (que aciona `/branding-onboard` quando disponível).
4. Se rodando standalone: pergunta se usuário quer prosseguir para a próxima fase.
